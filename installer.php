...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'VAER_v1_3f70736619b975867147_20220529095344_archive.zip';
	const ARCHIVE_SIZE		 = '134449433';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3f70736-29095344';
    const SECONDARY_PACKAGE_HASH = '58d88dc-29095344';
	const VERSION			 = '1.4.6';
